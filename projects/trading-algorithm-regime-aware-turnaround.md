...
This was a capital-governance turnaround after a $150 million loss, not a model-tuning exercise. I designed the recovery architecture that determined when the strategy could trade, how much capital it could regain, which risks remained outside the model, and what evidence Risk, Trading, Compliance, investors, and the investment committee would all use to release the next tranche.
